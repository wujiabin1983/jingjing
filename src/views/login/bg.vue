...
export default {
  data() {
    return {
      config: { // 配置
        ...
        count: 100,		//点个数
        color: "255, 10, 10", 	//点颜色
        stroke: "100,200,200", 		//线条颜色
        dist: 3000, 	//点吸附距离
        e_dist: 3000, 	//鼠标吸附加速距离
  ...
  mounted(){
    //调用
    this.CanvasParticle()(this.config);
  },
  methods: {
    CanvasParticle: function(){
      var that = this;
    	...
    	function canvasSize(canvas){
    		...
    		// 获取特定div的宽高
    		// var width = that.$refs.canvasBg.style.width;
    		// var height = that.$refs.canvasBg.style.height;
