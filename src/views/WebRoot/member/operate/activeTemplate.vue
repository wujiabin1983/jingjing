...
<script>
	import templateInfoOne from '@/views/WebRoot/member/component/templateOneTh'
	import templateInfoTwo from '@/views/WebRoot/member/component/templateTwoTh'
	import templateInfoThree from '@/views/WebRoot/member/component/templateThreeTh'
	import templateInfoFour from '@/views/WebRoot/member/component/templateFourTh'
	export default {
		data() {
			return {
				type: "",
		...
		methods: {
			...
			//					alert(3)
			//				}
			//				if(this.active++ >= this.nav) {
			//					this.active = this.nav - 1;
			//				}
			//			},
