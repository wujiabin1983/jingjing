<template>
	<el-container class="app-container">
		...
		<el-main>
			<el-card>
				<el-table ref="tableData" highlight-current-row :data="tableData" v-loading="tableLoading" border @current-change="handleSelectionChange">
	...
	export default {
		...
		methods: {
			...
			handleAffirm() {
				...
				let params = {
					id: this.multipleSelection.sellerId,
					name: this.multipleSelection.sellerMan,
				}
