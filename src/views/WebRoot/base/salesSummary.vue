...
<template>
	<el-container class="app-container">
		<el-header>
			<el-card>
				<el-form :inline="true" :model="form" class="demo-form-inline" v-if="roleBtn.selectSalesImportInfo">
					<el-form-item class="floatLeft">
						<el-button type="primary" @click="upload" v-if="roleBtn.importSaleslInfo">选择文件导入</el-button>
		...
		<el-main>
			<el-card>
				...
				<el-table ref="tableData" v-loading="this.tableLoading" :data="tableData" @selection-change="handleSelectionChange">
					...
					<el-table-column prop="uploadFiles" label="上传文件">
					...
					<el-table-column prop="action" width="60px" label="操作">
						<template slot-scope="scope">
							<!-- 功能图标 -->
...
<script>
	...
	import { salesImportInfo, salesImportDownload, salesImportFile } from '@/api/base/importInfo'
	...
	export default {
		data() {
			return {
				// 权限
				roleBtn: {
					selectSalesImportInfo: false,
					importSaleslInfo: false
				},
				// 搜索数据
				form: {
					selectDate: [] // 日期区间
